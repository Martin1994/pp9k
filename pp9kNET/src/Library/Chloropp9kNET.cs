...
{
    /// <summary>
    /// A .NET wrapper for libchloropp9k
    /// Provides event callbacks and thread safe methods
    /// </summary>
    public class Chloropp9kNET : IDisposable
    {
        internal const string pp9kLib = @"lib/libchloropp9k";
        ...
        /// <param name="prefer">Type to promote</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Show some information when exiting the game
        /// </summary>
        /// <returns></returns>
        public bool Exit()
        {
        ...
        [DllImport(pp9kLib, CallingConvention = CallingConvention.Cdecl)]
    ...
    /// <summary>
    /// Extensions to convert enums between .NET and native code
    /// </summary>
    public static class Chloropp9kNETEnumExtensions
    {
        ...
        [DllImport(Chloropp9kNET.pp9kLib, CallingConvention = CallingConvention.Cdecl)]
